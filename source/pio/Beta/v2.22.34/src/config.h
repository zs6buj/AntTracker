...
uint16_t  UDP_LOCALPORT = 14550;    // readPort, remote host (like MP and QGC) expects to send to this port - Frsky +1
uint16_t  UDP_REMOTEPORT = 14555;   // sendPort, remote host reads from this port
