...
#if (MEDIUM_IN == 0) || (MEDIUM_IN == 3) ||  (MEDIUM_IN == 4)    //  FrSky (Serial, UDP or BT)
  ...
  uint8_t   fr_offset = 0;
    ...
    void FrSky_Receive(uint8_t proto) {
      #if (MEDIUM_IN == 0) ||  ((defined btBuiltin) &&  (MEDIUM_IN == 4))       //   FrSky Serial or BT
        Frs_Receive_Serial_BT(proto);
      #endif
   
      #if (defined wifiBuiltin) &&  (MEDIUM_IN == 3)  //   FrSky UDP 
    ...
    //=======================================================================
    #if (defined wifiBuiltin) &&  (MEDIUM_IN == 3)          // UDP
    ...
    //================================================================
  #if (MEDIUM_IN == 0) || ( (defined btBuiltin) &&  (MEDIUM_IN == 4) )  // Serial or BT
