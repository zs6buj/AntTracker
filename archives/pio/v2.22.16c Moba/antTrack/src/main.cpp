...
// =======================  S E T U P   E E P R O M   =======================
  ...
  */
  ...
  delay(10);
    ...
    #endif      
    #if (ESP32_VARIANT == 9)
      log.println("LILYGO T-HMI ESP32-S3 2.8 inch Resistive Touch Screen TF card");
      logScreenPrintln("LILYGO T-HMI ESP32-S3");
    #endif 
    #if (ESP32_VARIANT == 10)
      log.println("Heltec Wifi Kit 32 V3 (S3)");
      logScreenPrintln("Heltec WifiKit32 V3 S3");
    #endif     
  #elif (defined ESP8266) 
  ...
  /* We choose not to use the SPI attach methos, but rather pulse pin and direction pin */
