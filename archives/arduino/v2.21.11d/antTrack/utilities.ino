...
//=================================================================================================   
    ...
    uint16_t readUDP()
  {
    ...
    #if (WIFI_MODE == 2)  // STA
      active_udp_obj_idx = 0;             // Use STA UDP object for read
    ...
    #endif
    #if (WIFI_MODE == 1)  // AP
        active_udp_obj_idx = 1; // Use AP UDP object for read
    ...
    //log.printf("Read UDP object=%d port:%d  packetSize:%d\n", active_udp_obj_idx, udp_read_port, packetSize);
    if (packetSize)
      {
...
//=================================================================================================  
  ...
  void SetupWiFi() { 
    ...
    bool apMode = false;  // used when STA fails to connect
     ...
     // log.print(STAssid); 
      ...
      if (WiFi.status() == WL_CONNECTED) {
        ...
        wifiSuGood = true;
        wifiSuDone = true;
        active_udp_obj_idx = 0; // Use STA UDP object
      } 
    #endif
     //===============================  Access Point   =============================  
    ...
    if (apMode)   
    {
      ...
      log.print (localIP); 
      log.printf("  SSID: \"%s\"", String(APssid));
      ...
      wifiSuGood = true;
      active_udp_obj_idx = 1; // Use AP UDP object 
    }           
...
//================================================================================================= 
  ...
  #endif  // end of defined ESP32_VARIANT
                                          ...
                                          uint8_t* pData, size_t length, bool isNotify) 
  {
    ...
    */
    //store record value
      ...
      log.printf("pD len:%u  pData:", length);
    ...
    {
      if ((protocol == 3) && (pData[i] == 0x7D) && (j != 0) && (j != 11) && (j != 12) && (j != 11))  // s.port and not a start or stop character
      {
        i++;
        msgBuf[j] = pData[i];
        msgBuf[j] ^= 0x20;  // XOR
