...
// zs6buj
#define ESP32_S_OR_C  CONFIG_IDF_TARGET_ESP32S2 || CONFIG_IDF_TARGET_ESP32S3 || CONFIG_IDF_TARGET_ESP32S6 || CONFIG_IDF_TARGET_ESP32C2 || CONFIG_IDF_TARGET_ESP32C3 || CONFIG_IDF_TARGET_ESP32C6
#if ESP32_S_OR_C
	// zs6buj #error This ESP32 version is not supported
    #define MAX_PWM 8
#else
    #define MAX_PWM 16
#endif
...
#ifdef USE_VSPI  // SPI3
    #define VSPI 3     // zs6buj
    #define SPI_USED    VSPI
    #define MOSI        23
    #define SCK         18
    #define SS          5
#else
    // HSPI (SPI2) is used by default
...
extern pwmUse_t pwmUse[MAX_PWM]; // zs6buj - was 16
