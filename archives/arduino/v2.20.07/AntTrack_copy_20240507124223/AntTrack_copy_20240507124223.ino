...
void setup() {
  ...
  log.printf(" version:%d.%02d.%02d\n", MAJOR_VERSION,  MINOR_VERSION, PATCH_LEVEL);
   ...
   #if (defined ESP32) && ( (MEDIUM_IN == 2) || (MEDIUM_IN == 3)) && (defined DEBUG_WiFi)
...
//=================================================================================================   
  ...
  #if (MEDIUM_IN  == 5)  // Generic Bluetooth  - ESP only
...
// ======================== Setup Serial ==============================
  ...
  #if (MEDIUM_IN == 0)    //  Serial telemetry in
      ...
      #endif
    #endif
  #endif // end of MEDIUM_IN == 0 == inSerial
   
  // ================================  Setup WiFi  ====================================
  #if (defined ESP32)  || (defined ESP8266)

   #if (MEDIUM_IN == 2) || (MEDIUM_IN == 3)  //  WiFi Mavlink or FrSky
     SetupWiFi();    
    #endif  
  #endif  
...
void loop() {            
  ...
  #if (MEDIUM_IN == 1)         // Bluetooth
    Mavlink_Receive();
  #endif
  #if (MEDIUM_IN == 2)         // Mavlink WiFi
    ...
    #endif   
  #endif
  #if (MEDIUM_IN == 3)         //   FrSky UDP
      if (wifiSuGood) {     
        FrSky_Receive(PROTOCOL);
      }
  #endif
  #if (MEDIUM_IN == 4)         //   FrSky BT
      if (btSuGood) {     
        FrSky_Receive(PROTOCOL);
      }
  #endif
  ...
  #if (MEDIUM_IN == 0)    // Serial according to protocol
    switch(protocol) {
