...
//=============================================================================================
//======================  I N P U T   C H A N N E L       How does telemetPROTOCOLry enter the tracker?
//=============================================================================================
// Choose one only of these input channels 
//#define MEDIUM_IN  0    // Serial Port (default) - all protocols        
//#define MEDIUM_IN  1    // Mavlink BlueTooth Classic- ESP32 
//#define MEDIUM_IN  2    // Mavlink WiFi - ESP only
//#define MEDIUM_IN  3    // FrSky UDP - ESP only
//#define MEDIUM_IN  4    // FrSky BT classic - ESP32 only
#define MEDIUM_IN  5    // Bluetooth classic 

//=============================================================================================
//================================  T E L E M E T R Y   P R O T O C O L  ======================
//=============================================================================================
// Select only one telemetry PROTOCOL here
//DO NOT USE FOR NOW  #define PROTOCOL 0     // AUTO detect protocol
...
// Using official stmicroelectronics lib: https://github.com/stm32duino/BoardManagerFiles/raw/main/package_stmicroelectronics_index.json 
  ...
  #if (defined ESP32 || defined ESP8266) && ((MEDIUM_IN == 2) || (MEDIUM_IN == 3))
    #define wifiBuiltin   //  for this feature we need wifi support compiled in
  #endif    

   #if (defined ESP32 || defined ESP8266) && ( (MEDIUM_IN == 1) || (MEDIUM_IN == 4) )
    #define btBuiltin   //  for this feature we need bluetooth support compiled in
  #endif

 #if ( (defined ESP32) && (MEDIUM_IN  == 1) )
...
//============================================================================================= 
  ...
  uint8_t headingsource = HEADINGSOURCE;
    ...
    #endif 
    #if (MEDIUM_IN == 3)    // FrSky UDP - ESP only
...
// For info: Avoid SPI pins - generally   CS=5    MOSI=23   MISO=19   SCK=18  
  ...
  */
...
#if (MEDIUM_IN == 1) || (MEDIUM_IN == 4)  || (MEDIUM_IN == 5)     // Bluetooth
  #if (defined ESP32) 
  ...
  #if (MEDIUM_IN == 5)       // BLUETOOTH
    BluetoothSerial inSerial;   // instantiate BluetoothSerial object  as  generic inSerial
  #endif  

  #if (MEDIUM_IN == 0)     // Serial UART
    #if (PROTOCOL == 9)
