...
v2.02 2019-03-12 Tidy up GPS code   
 */
...
void FinalStoreHome() {
   ...
   switch(Heading_Source) {
      ...
      case 1:    // // GPS 
        if (homStored) {            // Use home established when 3D+ lock established, homStored = 1 
