...
//=================================================================================================   
  ...
  snprintf(snprintf_buf, snp_max, "Target Board = %u  ", Target_Board);
  Log.print(snprintf_buf);    
  delay (500); //xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
    ...
    #endif      
  #endif
  delay (500); Log.println("Reached 02"); delay (500); 
  #if (Telemetry_In == 0)  // Serial
    Log.println("Serial Telemetry In");
    delay(100);   //xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
  ...
  #endif
     delay (1000); Log.println("Reached 03"); delay (1000); 
  EEPROM_Setup();
  delay (1000); Log.println("Reached 04"); delay (1000); 
  ...
  delay (1000); Log.println("Reached 05"); delay (1000); 
  DisplayHeadingSource();
delay (1000); Log.println("Reached 07");  delay (1000);
  #ifdef QLRS
...
delay (1000); Log.println("Reached 08");  delay (1000);
...
// ======================== Setup Serial ==============================
  ...
  #endif
delay (1000); Log.println("Reached 09");  delay (1000);
  ...
  delay (1000); Log.println("Reached 10");  delay (1000);  
    #if ( (defined ESP8266) || (defined ESP32) ) 
      delay(100);
      ...
      inSerial.begin(inBaud); // Teensy 3.x    rx tx pins hard wired
       ...
       #endif    
    #else
      delay (500); Log.println("Reached 11");  delay (500);
      inSerial.begin(inBaud);
    #endif   
  delay (1000); Log.println("Reached 12");  delay (1000);
  #endif
...
void FinalStoreHome() {
   ...
   if (headingSource == 2) { // Flight Computer  
