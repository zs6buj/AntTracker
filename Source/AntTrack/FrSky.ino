 ...
 // * **D** : number of satellites locked (if 14 satellites are locked, C = 1 & D = 4)    
                    ...
                    pt_gps_homereset = bytes[0] & 0x04;
                    pt_gps_accuracy = bytes[1];
                    pt_gps_numsats = (bytes[2] * 10) + bytes[3];                    
                 ...
                 //   X mode, Mavlink Passthrough Protocol below    
                 //===================================================================
                 case 0xF000:   
                   break;
                 case 0xF101:                        // RSSI  
        ...
        //Log.printf("gpsGood:%u  hdopGood:%u  lonGood:%u  latGood:%u  altGood:%u  hdgGood:%u\n", gpsGood, hdopGood, lonGood, latGood, altGood, hdgGood);
