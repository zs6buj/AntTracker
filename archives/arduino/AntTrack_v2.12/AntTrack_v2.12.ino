...
// ************************ Setup Bluetooth ***************************  
  ...
  // ************************* Setup WiFi **************************** 
      ...
      OledDisplayln(localIP.toString());  
       ...
       Debug.println("Waiting for client to connect");
       OledDisplayln("Waiting for client"); 
      ...
      if (WiFi.status() == WL_CONNECTED) {
        ...
        Debug.println(" failed to connect. Aborting");
        OledDisplayln("Failed. Aborting");
        while (true) delay(1000);   // wait here forever
      }
    #endif
  #endif
 #endif    // target board
