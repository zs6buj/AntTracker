...
byte x;
  ...
  // Data is available
  telGood = true;                     // We have a good serial connection!
  x =inSerial.read();
...
void ProcessData() {
 ...
 uint16_t ValueType = Unpack_uint16(3);
                ...
                //   Regular S.Port X Protocol below    
                 ...
                 //   Mavlink Passthrough Protocol below     
                  ...
                  // GPS Status &  gpsAlt
                    ...
                    if (!pt_dia) {
                      pt_dia=true;
                         OledDisplayln("Passthru dialect"); 
                    }
    ...
    if (Heading_Source==1 && (gpsGood) && (!homStored)) AutoStoreHome();  // Only need this when Heading_Source is GPS 
}
